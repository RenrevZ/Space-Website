...
function appendData(data) {
    let role_crew = data.technology[n-1].role;
  ...
  let name_technology = data.technology[n-1].name;
  let name_technology_h2 = document.createElement('h2');
  name_technology_h2.classList.add('Title-strong')
  name_technology_h2.innerHTML = name_technology;
  textCrew.append(name_technology_h2)
  // Getting bio of crew
  let bio_technology = data.technology[n-1].description;
  let bio_technology_h2 = document.createElement('div');
  bio_technology_h2.classList.add('title-paragraph')
  bio_technology_h2.innerHTML = bio_technology;
  textCrew.append(bio_technology_h2)
